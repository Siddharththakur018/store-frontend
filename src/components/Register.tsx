...
const Register:React.FC<RegisterProps> = ({ onLoginClick }) => {
  ...
  return (
    <div className="p-3 flex justify-center items-center flex-col">
      <h2 className="text-gray-400 text-3xl font-bold mb-1 text-center">Create Store Account Now!</h2>
      <p className="text-gray-400 text-lg font-bold mb-3">
        Register with your details to get started
      </p>
      <form onSubmit={handleSubmit} className="mt-3 w-3/4 mb-2">
      <div>
      ...
      <div className="text-black flex items-center w-full gap-2 my-2">
      ...
      <div onClick={onLoginClick} className="underline text-blue-500 mt-2 cursor-pointer">
        Login Now
      </div>
    </div>
  );
